...
## 버전
**v1.0** — 공개본 (W.A.Y? 내부판 v1.2 기반 일반화). 개인정보·운영 식별자 제거, 운영 개념(SVOP·Mode Toggle·외부조회·모름5모드·Critical Path Best-of-N·MCP신뢰도·결재흐름·메모리·컨텍스트관리·우선순위) 100% 보존. [미구현]/[미가동] 정직 표기(SVOP 자기적용)는 보존.
